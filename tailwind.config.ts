...
export default {
  ...
  // Remove experimental features to avoid warnings
  safelist: [
    // Ensure all facet color utilities are included for dynamic generation
    {
      pattern:
        /^(bg|text|border|ring|decoration)-facet-(ontology|epistemology|praxeology|axiology|mythology|cosmology|teleology)-(50|100|200|300|400|500|600|700|800|900|DEFAULT)$/,
      variants: ["hover", "focus", "active", "group-hover", "dark"],
    },
    {
      pattern:
        /^bg-gradient-(facet-spectrum|facet-spectrum-radial|ontology-epistemology|epistemology-praxeology|praxeology-axiology|axiology-mythology|mythology-cosmology|cosmology-teleology|teleology-ontology)$/,
    },
  ...
  theme: {
    ...
    spacing: {
      ...
      "80": "20rem", // 320px
      "96": "24rem", // 384px
      // Custom prism and glass spacing
      "prism-xs": "0.125rem", // 2px
      "prism-sm": "0.5rem", // 8px
      "prism-md": "1rem", // 16px
      "prism-lg": "1.5rem", // 24px
      "prism-xl": "2rem", // 32px
      "glass-sm": "0.75rem", // 12px
      "glass-md": "1rem", // 16px
    ...
    extend: {
      ...
      backdropBlur: {
        ...
        "2xl": "40px",
        "3xl": "64px",
        // Custom glass and prism blur values
        glass: "8px",
        prism: "16px",
        crystal: "24px",
      },
      ...
      boxShadow: {
        ...
        "glass-md": "0 12px 24px 0 rgba(31, 38, 135, 0.35)",
        glow: "0 0 20px rgba(139, 92, 246, 0.3)",
        "glow-lg": "0 0 40px rgba(139, 92, 246, 0.4)",
        "facet-glow":
          "0 0 20px var(--facet-glow-color, rgba(139, 92, 246, 0.3))",
        "inner-glow": "inset 0 2px 4px 0 rgba(255, 255, 255, 0.1)",
        // Custom prism and spectrum shadows
        beautiful:
          "0 10px 25px rgba(139, 92, 246, 0.15), 0 4px 10px rgba(0, 0, 0, 0.1)",
        prism:
          "0 20px 40px rgba(139, 92, 246, 0.3), 0 8px 16px rgba(0, 0, 0, 0.2)",
        spectrum:
          "0 0 30px rgba(139, 92, 246, 0.4), 0 0 60px rgba(99, 102, 241, 0.2)",
        "glow-ontology": "0 0 30px rgba(139, 92, 246, 0.4)",
      ...
      colors: {
        ...
        glass: {
          ...
          "light-xs": "rgba(255, 255, 255, 0.03)",
          "light-sm": "rgba(255, 255, 255, 0.08)",
          "light-md": "rgba(255, 255, 255, 0.12)",
          "light-lg": "rgba(255, 255, 255, 0.15)",
          dark: "rgba(0, 0, 0, 0.1)",
          "dark-lg": "rgba(0, 0, 0, 0.2)",
          "border-light": "rgba(255, 255, 255, 0.1)",
          "border-medium": "rgba(255, 255, 255, 0.2)",
          "border-strong": "rgba(255, 255, 255, 0.3)",
        },
        // Facet color aliases for theme() function access
        ontology: {
          "50": "#f5f3ff",
          "100": "#ede9fe",
          "200": "#ddd6fe",
      ...
      backgroundImage: {
        ...
        "gradient-facet-spectrum":
          "linear-gradient(to right, #8b5cf6, #6366f1, #3b82f6, #10b981, #eab308, #f97316, #ef4444)",
        "gradient-facet-spectrum-radial":
          "radial-gradient(circle, #8b5cf6, #6366f1, #3b82f6, #10b981, #eab308, #f97316, #ef4444)",
        "gradient-facet-spectrum-conic":
          "conic-gradient(from 0deg, #8b5cf6, #6366f1, #3b82f6, #10b981, #eab308, #f97316, #ef4444, #8b5cf6)",
        // Adjacent facet pairs for smooth transitions
        "gradient-ontology-epistemology":
          "linear-gradient(to right, #8b5cf6, #6366f1)",
        "gradient-epistemology-praxeology":
          "linear-gradient(to right, #6366f1, #3b82f6)",
        "gradient-praxeology-axiology":
          "linear-gradient(to right, #3b82f6, #10b981)",
        "gradient-axiology-mythology":
          "linear-gradient(to right, #10b981, #eab308)",
        "gradient-mythology-cosmology":
          "linear-gradient(to right, #eab308, #f97316)",
        "gradient-cosmology-teleology":
          "linear-gradient(to right, #f97316, #ef4444)",
        "gradient-teleology-ontology":
      ...
      keyframes: {
        ...
        "facet-glow": {
          ...
          "50%": {
            boxShadow:
              "0 0 40px var(--facet-glow-color, rgba(139, 92, 246, 0.5))",
          },
        },
        "fade-in-up": {
          "0%": {
