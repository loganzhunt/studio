...
export function Header() {
  ...
  const { currentUser, signOutUser, openAuthModal } = useWorldview();
  ...
  return (
    <>
      <header className="sticky top-0 z-50 w-full border-b border-border/30 bg-background/80 backdrop-blur-md">
        <div className="flex h-16 items-center justify-between px-16 py-3">
          {" "}
          {/* Increased px from 12 to 16 */}
          <Link
            href="/"
          ...
          <nav className="hidden md:flex flex-1 justify-start items-center gap-2 ml-6">
            {" "}
            {/* Decreased gap from 4 to 2 */}
          ...
          <div className="flex items-center space-x-2">
            {currentUser ? (
              <DropdownMenu>
                ...
                <DropdownMenuContent
                  className="w-72 glassmorphic-card mt-2 p-4"
                  align="end"
                  forceMount
                >
                  ...
                  <DropdownMenuItem
                    asChild
                    className="cursor-pointer hover:bg-muted/50 focus:bg-muted/50 p-2.5"
                  >
                    <Link
                      href="/dashboard"
            ...
            <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
              ...
              <SheetContent
                side="right"
                className="w-[300px] sm:w-[320px] bg-background/95 backdrop-blur-md p-0"
              >
