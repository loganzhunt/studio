...
export const SpectrumBar: React.FC<SpectrumBarProps> = ({
  ...
  return (
    <div className={cn('spectrum-bar relative w-full h-2 rounded-full overflow-hidden', className)}>
      <div 
...
export const HeroShimmer: React.FC<HeroShimmerProps> = ({ className }) => {
  return (
    <div className={cn('hero-shimmer relative overflow-hidden', className)}>
...
export const SpectrumIcon: React.FC<SpectrumIconProps> = ({ className }) => {
  return (
    <div className={cn('spectrum-icon relative w-8 h-8', className)}>
      <div className="absolute inset-0 rounded-full bg-gradient-to-r from-red-500 via-yellow-500 via-green-500 via-blue-500 to-purple-500" />
    </div>
  );
};
