...
export const ADDITIONAL_CODEX_DATA: any[] = [
  // Batch 1 (Empiricism to Taoism from previous prompts)
  // Note: Some of these might be overridden by LATEST_CODEX_UPDATE_BATCH if titles match
  {
    "name": "Empiricism", // This one should be overridden by LATEST_CODEX_UPDATE_BATCH
  ...
  {
    "title": "Existentialism", // Also in BASE_CODEX_DATA, this might be overridden by LATEST or BASE
    "category": "philosophical - Worldview",
  ...
  {
    "title": "Mystical Sufism", // Also in BASE_CODEX_DATA, this version will take precedence if LATEST_CODEX_UPDATE_BATCH doesn't have it
    "category": "religious - Worldview",
  ...
  {
    "title": "Platonism", // Also in BASE_CODEX_DATA, this version will take precedence if LATEST_CODEX_UPDATE_BATCH doesn't have it
    "category": "philosophical - Worldview",
  ...
  {
    "title": "Scientific Materialism", // Also in BASE_CODEX_DATA, this version will take precedence if LATEST_CODEX_UPDATE_BATCH doesn't have it
    "category": "philosophical - Worldview",
  ...
  {
    "title": "Stoicism", // Also in BASE_CODEX_DATA, this version will take precedence if LATEST_CODEX_UPDATE_BATCH doesn't have it
    "category": "philosophical - Worldview",
  ...
  {
    "title": "Taoism", // Also in BASE_CODEX_DATA, this version will take precedence if LATEST_CODEX_UPDATE_BATCH doesn't have it
    "category": "religious - Worldview",
