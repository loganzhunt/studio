      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                return (
                  <div key={facetName} className="p-4 rounded-md border border-border/30 bg-background/40">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      >
                        <SelectTrigger id={`${facetName}-select`} className="flex-grow bg-muted/80 border-border/60 hover:bg-muted/90">
                      ...
                      <Button variant="outline" size="sm" className="bg-muted/60 border-border/60 hover:bg-muted/80 text-foreground/90 hover:text-foreground" asChild>
        ...
        <div className="space-y-6">
          <Card className="glassmorphic-card sticky top-24"> {/* Sticky for visibility */}
            ...
            <CardContent>
              <TriangleChart scores={builderDomainScores} worldviewName={worldviewTitle || "Custom Worldview"} className="mx-auto mb-6 !p-0 !bg-transparent !shadow-none !backdrop-blur-none" width={250} height={217} />
              <div className="mb-4">
