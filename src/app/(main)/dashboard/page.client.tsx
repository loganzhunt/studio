...
import { mapRawArchetypeToCodexEntry } from "@/lib/codex-utils";
...
const rawArchetypeData: any[] = [
  {
    ...
    summary:
      "Grounded in evidence and logic, the Rational Skeptic seeks truth through reasoned inquiry and is wary of metaphysical speculation.",
    scores: {
      ontology: 0.15,
      epistemology: 0.05,
      praxeology: 0.8,
    ...
    facetDescriptions: {
      ontology:
        "Sees reality as fundamentally material; trusts in what can be measured.",
      epistemology:
        "Strongly favors empirical observation and skepticism over revelation.",
      praxeology:
        "Prefers structured, hierarchical systems and established authority.",
      axiology:
        "Values personal autonomy and achievement over collective or spiritual ideals.",
      mythology: "Views history and experience as linear progress.",
      cosmology: "Explains the universe in mechanistic, scientific terms.",
      teleology:
        "Sees purpose as self-determined, existential, and grounded in this life.",
    },
  },
  {
    title: "The Integral Synthesizer",
    summary:
      "Bridges and integrates diverse perspectives, holding paradox and complexity as necessary for a whole worldview.",
    scores: {
      ontology: 0.55,
      epistemology: 0.5,
      praxeology: 0.5,
    ...
    facetDescriptions: {
      ontology:
        "Holds reality as a balance of material and ideal; integrates multiple layers.",
      epistemology:
        "Values both empirical and revelatory sources; open to complexity.",
      praxeology:
        "Balances respect for authority with egalitarian participation.",
      axiology: "Blends personal and collective values for a humanistic ethic.",
      mythology:
        "Sees meaning as cyclical and evolving, embracing stories from many sources.",
      cosmology:
        "Perceives the cosmos as both holistic and open to scientific understanding.",
      teleology:
        "Purpose is found in harmonizing self and world, with openness to mystery.",
    },
  },
  {
    title: "The Transcendent Mystic", // Changed from "The Mystic Pilgrim" to match data if needed
    summary:
      "Sees all of existence as sacred and interconnected, guided by direct spiritual insight. Values self-transcendence, unity, and surrender to higher meaning.",
    scores: {
      ontology: 0.9,
      epistemology: 0.85,
      praxeology: 0.3,
    ...
    facetDescriptions: {
      ontology:
        "Sees reality as fundamentally ideal or spiritual, rooted in unity or consciousness.",
      epistemology:
        "Gains knowledge through revelation, intuition, or mystical insight.",
      praxeology:
        "Prefers non-hierarchical, contemplative, or surrender-based action.",
      axiology:
        "Values selfless love, devotion, and sacred ideals over individual gain.",
      mythology:
        "Finds resonance in cyclical, mythic, and transpersonal stories.",
      cosmology: "Views the universe as holistic and interconnected.",
      teleology:
  ...
  },
  {
    ...
    summary:
      "Grounded in rational ethics, scientific method, and belief in human progress.",
    scores: {
      ontology: 0.2,
      epistemology: 0.25,
      praxeology: 0.4,
    ...
    facetDescriptions: {
      ontology:
        "Leans materialist, seeing people and relationships as the core of reality.",
      epistemology:
        "Values evidence, critical thinking, and reasoned dialogue.",
      praxeology:
        "Prefers systems that are merit-based but support collective good.",
      axiology: "Blends individual dignity with social compassion and justice.",
      mythology: "Draws meaning from human stories and cultural narratives.",
      cosmology:
        "Views the universe as understandable and shaped by human inquiry.",
      teleology:
        "Sees meaning as constructed, existential, and rooted in this world.",
    },
  },
  {
    title: "The Earth-Centered Animist", // Changed from "The Cosmic Animist"
    summary:
      "Views the world as alive, reciprocal, and sacred; values ecological harmony and ancestral continuity.",
    scores: {
      ontology: 0.85,
      epistemology: 0.6,
      praxeology: 0.4,
    ...
    facetDescriptions: {
      ontology:
        "Sees reality as inherently alive, relational, and animated by spirit.",
      epistemology:
        "Balances observation with revelatory ways of knowing (dream, vision).",
      praxeology: "Values egalitarian, reciprocal, and collective practices.",
      axiology: "Prioritizes interdependence, respect, and stewardship.",
      mythology:
        "Meaning is found in cyclical, living, and place-based stories.",
      cosmology: "Views cosmos as holistic and animate.",
      teleology: "Purpose is to participate in the living web of existence.",
    },
  },
  {
    title: "The Archetypal Traditionalist", // Added "The Pragmatic Modernist" as this one.
    summary:
      "Upholds sacred order, divine authority, and moral duty rooted in religious tradition.",
    scores: {
      ontology: 0.4,
      epistemology: 0.3,
      praxeology: 0.5,
    ...
    facetDescriptions: {
      ontology: "Reality is ordered by tradition and divine principles.",
      epistemology: "Knowledge comes from sacred texts and lineage.",
      praxeology: "Action is guided by established duties and rituals.",
      axiology: "Values heritage, obedience, and communal harmony.",
      mythology: "Upholds foundational myths and religious narratives.",
      cosmology: "Universe is seen as divinely structured and meaningful.",
      teleology: "Purpose is to live according to divine law and tradition.",
    },
  },
  {
    title: "The Existential Individualist", // Changed from "The Existential Explorer"
    summary:
      "Asserts self-determined meaning, embraces uncertainty, and rejects cosmic absolutes.",
    scores: {
      ontology: 0.4,
      epistemology: 0.4,
      praxeology: 0.45,
    ...
    facetDescriptions: {
      ontology:
        "Balances between material and ideal, questioning fixed reality.",
      epistemology: "Explores both empirical and revelatory ways of knowing.",
      praxeology:
        "Resists rigid hierarchy; favors flexible, individual action.",
      axiology: "Values personal meaning and creative expression.",
      mythology:
        "Draws from diverse stories, often in cyclical or disrupted form.",
      cosmology: "Views cosmos as open, uncertain, and in flux.",
      teleology: "Sees purpose as existential, chosen, and ambiguous.",
    },
  },
  {
    title: "The Stoic Rationalist", // Changed from "The Ethical Altruist"
    summary:
      "Sees life as ordered by reason and fate, values virtue, and emphasizes inner discipline.",
    scores: {
      ontology: 0.4,
      epistemology: 0.5,
      praxeology: 0.8,
    ...
    facetDescriptions: {
      ontology: "Materialist or dualist; reason is part of nature.",
      epistemology: "Reasoned reflection; self-examination.",
      praxeology: "Virtuous action, self-control, resilience.",
      axiology: "Values wisdom, virtue, equanimity.",
      mythology: "Draws from Greco-Roman myths for exemplars.",
      cosmology: "Universe as rational, ordered whole.",
      teleology: "Purpose is to live in harmony with nature and reason.",
    },
  },
  {
    title: "The Visionary Idealist",
    summary:
      "Imagines higher possibilities, pursuing beauty, truth, and the Good as guiding ideals for self and society.",
    scores: {
      ontology: 0.8,
      epistemology: 0.75,
      praxeology: 0.6,
    ...
    facetDescriptions: {
      ontology:
        "Sees reality as rooted in ideals, archetypes, and higher patterns.",
      epistemology: "Trusts intuition, vision, and philosophical reflection.",
      praxeology: "Balances individual striving with service to the whole.",
      axiology: "Prioritizes beauty, truth, and transcendent values.",
      mythology: "Finds meaning in mythic cycles and symbolic stories.",
      cosmology: "Cosmos is holistic, harmonious, and purposeful.",
      teleology:
        "Purpose is to realize the Good and contribute to higher meaning.",
    },
  },
  {
    title: "The Contemplative Realist", // Changed from "The Relational Steward"
    summary:
      "Grounded in realism but open to mystery, this archetype values awareness, modesty, and interior clarity.",
    scores: {
      ontology: 0.5,
      epistemology: 0.6,
      praxeology: 0.5,
    ...
    facetDescriptions: {
      ontology: "Reality is what is, but also includes subjective depth.",
      epistemology:
        "Balances empirical observation with introspective awareness.",
      praxeology: "Acts mindfully and with consideration for nuance.",
      axiology: "Values clarity, peace, and authentic understanding.",
      mythology: "Interprets myths for psychological or spiritual insight.",
      cosmology: "Universe is real, and our perception of it matters.",
      teleology: "Purpose is found in awareness and living authentically.",
    },
  },
];
...
const calculateSimilarity = (
  ...
  try {
    ...
    const similarity =
      (dotProduct / (userMagnitude * archetypeMagnitude)) * 100;
...
const getQualitativeScoreDescription = (
  score: number | undefined,
  facetName: FacetName | undefined
): string => {
  if (score === undefined || !facetName || !FACETS[facetName])
  ...
  if (anchors.length === 3) {
    ...
    return score < 0.5
      ? `Aligns more with: ${anchors[0]}`
      : `Aligns more with: ${anchors[1]}`;
...
const getDetailedInterpretation = (
  ...
  if (
    ...
    !facetName ||
    !FACETS[facetName] ||
    !FACETS[facetName].deepDive?.whatIfInterpretations
  ) {
...
export default function DashboardPage() {
  const { currentUser, openAuthModal, userDomainScores, hasAssessmentBeenRun } =
    useWorldview();

  const [selectedArchetypeForDrawer, setSelectedArchetypeForDrawer] =
    useState<CodexEntry | null>(null);
  const [isArchetypeDrawerOpen, setIsArchetypeDrawerOpen] = useState(false);
  const [selectedFacetForInsight, setSelectedFacetForInsight] =
    useState<FacetName | null>(null);
  const [isInsightPanelOpen, setIsInsightPanelOpen] = useState(false);

  // Fixed type mismatch, undefined variable, and implicit any type issues.

  // Ensure `mappedArchetypes` is correctly typed.
  const mappedArchetypes: CodexEntry[] = useMemo(() => {
    return rawArchetypeData
      .map((raw) => mapRawArchetypeToCodexEntry(raw))
      .filter(Boolean) as CodexEntry[];
  }, []);

  // Define a default value for `defaultNeutralScores`.
  const defaultNeutralScores: DomainScore[] = FACET_NAMES.map((facetName) => ({
    facetName,
    score: 0.5,
  }));

  const scoresForMainTriangle = useMemo(() => {
    return hasAssessmentBeenRun &&
      userDomainScores &&
  ...
  const topThreeMatches = useMemo(() => {
    if (
      ...
      !userDomainScores ||
      userDomainScores.length === 0 ||
      !Array.isArray(mappedArchetypes) ||
      mappedArchetypes.length === 0
    ) {
      return [];
    }
    try {
      return mappedArchetypes
        .filter(
          (archetype) =>
            ...
            Array.isArray(archetype.domainScores)
        )
        .map((archetype) => {
          return {
            ...archetype,
  ...
  const currentSelectedFacetData = selectedFacetForInsight
    ? FACETS[selectedFacetForInsight]
    : null;

  // Adding null checks and default values to handle potential null or undefined values.
  const safeSelectedArchetype = selectedArchetypeForDrawer || {};
  const safeCurrentSelectedFacetData = currentSelectedFacetData || {};

  // Adding a fallback for domainScores to ensure it is always defined.
  const safeDomainScores =
    selectedArchetypeForDrawer?.domainScores || defaultNeutralScores;

  const currentUserScoreForSelectedFacet =
    selectedFacetForInsight &&
    userDomainScores?.find((ds) => ds.facetName === selectedFacetForInsight)
      ?.score;
  ...
  const renderDomainFeedbackBars = () => {
    ...
    return Array.isArray(FACET_NAMES) && FACET_NAMES.length > 0
      ? FACET_NAMES.map((facetName) => {
          const scoreObj = scoresToDisplay.find(
          ...
          if (!facetConfig) {
            return (
              <div
                key={facetName}
                className="mb-4 p-3 rounded-md border border-destructive/50 bg-destructive/10"
              >
                <p className="text-destructive text-sm">
                  Configuration error for facet: {facetName}
                </p>
              </div>
            );
          }
    ...
    <TooltipProvider>
      <div className="container mx-auto py-12 space-y-12">
          ...
          {currentUser ? (
            <>
              ...
              <p className="text-muted-foreground mt-1">
                This is your Meta-Prism dashboard.
              </p>
            </>
          ) : (
            <>
              <h1 className="text-3xl font-bold text-foreground">
                Welcome to Meta-Prism!
              </h1>
              <p className="text-muted-foreground mt-1">
          ...
          <div className="text-center mb-6">
            ...
            {!hasAssessmentBeenRun && (
              <p className="text-muted-foreground mt-3">
                Complete the assessment to reveal your unique pattern.
              </p>
            )}
          </div>
          ...
          <GlassCard animated>
            <div className="mb-6">
              ...
              <p className="text-muted-foreground text-xs">
                Reflections on your dominant facet alignment.
              </p>
            </div>
            <div>
              {hasAssessmentBeenRun &&
              ...
              userDomainScores.length > 0 ? (
                (() => {
                  ...
                  const dominantScoreObj = userDomainScores.find(
                    (s) => s.facetName === dominantFacetName
                  );
                  const dominantScore = dominantScoreObj
                    ? dominantScoreObj.score
                    : undefined;

                  if (dominantScore === undefined || !dominantFacetName) {
                    return (
                      <p className="text-muted-foreground text-sm">
                        Could not determine dominant facet score.
                      </p>
                    );
                  }
                  const facetConfig = FACETS[dominantFacetName];
                  const qualitativeDesc = getQualitativeScoreDescription(
                    dominantScore,
                    dominantFacetName
                  );
                  ...
                  return (
                    <p className="text-muted-foreground text-sm">
                      Your dominant facet appears to be{" "}
                      <span
                        className={`font-semibold ${getFacetClass(
                          "text",
                          dominantFacetName.toLowerCase() as any,
                          "700"
                        )}`}
                      >
                        {dominantFacetName}
                      ...
                      .
                      {` Your alignment (${Math.round(
                        dominantScore * 100
                      )}%) ${qualitativeDesc.toLowerCase()}.`}
                      {facetConfig?.deepDive?.whatIfInterpretations ? (
                        <>
                          {" " +
                            (dominantScore < 0.34
                              ? facetConfig.deepDive.whatIfInterpretations.low.split(
                                  "."
                                )[0] + "."
                              : dominantScore <= 0.66
                              ? facetConfig.deepDive.whatIfInterpretations.mid.split(
                                  "."
                                )[0] + "."
                              : facetConfig.deepDive.whatIfInterpretations.high.split(
                                  "."
                                )[0] + ".")}
                        </>
                      ) : (
                ...
                <p className="text-muted-foreground text-sm">
                  Complete the assessment to unlock insights about your
                  worldview.
                </p>
              )}
            </div>
          ...
          <div>
            {!hasAssessmentBeenRun ? (
                ...
                {topThreeMatches[0] && topThreeMatches[0].domainScores && (
                  <GlassCard className="border-primary/30 shadow-spectrum">
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        <h3
                          className={`text-xl font-semibold ${getFacetClass(
                            "text",
                            getDominantFacet(
                              topThreeMatches[0].domainScores
                            ).toLowerCase() as any,
                            "700"
                          )}`}
                        >
                        ...
                        <p className="text-muted-foreground text-sm">
                          Similarity:{" "}
                          {Math.round(topThreeMatches[0].similarity)}%
                        </p>
                      </div>
                      <PrismButton
                        size="small"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                      <div className="md:col-span-1 flex justify-center">
                        <TriangleChart
                          scores={topThreeMatches[0].domainScores}
              ...
              <p className="text-muted-foreground text-center py-8">
                Could not determine archetype matches. Ensure assessment is
                complete.
              </p>
            )}
          </div>
        ...
        {selectedArchetypeForDrawer && (
          <Sheet
            open={isArchetypeDrawerOpen}
            onOpenChange={setIsArchetypeDrawerOpen}
          >
            <SheetContent
                    ...
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <SheetDescription className="text-base capitalize">
                          {selectedArchetypeForDrawer.category} Profile
                        </SheetDescription>
                      </div>
                    </div>
                  </SheetHeader>
                  <p className="mb-6 text-muted-foreground leading-relaxed">
                    {selectedArchetypeForDrawer.summary}
                  </p>
                  <div className="space-y-4 mb-6">
                    <h3 className="text-xl font-semibold text-foreground mb-3 border-b border-border/30 pb-2">
                      Facet Breakdown
                    </h3>
                    {Array.isArray(FACET_NAMES) && FACET_NAMES.length > 0
                      ? FACET_NAMES.map((facetName) => {
                          ...
                          const facetConfig = FACETS[facetName];
                          let facetSummary = `Insights into how ${
                            selectedArchetypeForDrawer.title
                          } relates to ${facetName.toLowerCase()}...`;
                          if (
                            selectedArchetypeForDrawer.facetSummaries &&
                            selectedArchetypeForDrawer.facetSummaries[facetName]
                          ) {
                            facetSummary =
                              selectedArchetypeForDrawer.facetSummaries[
                                facetName
                          ...
                          const spectrumPoleLabels = SPECTRUM_LABELS[
                            facetName
                          ] || { left: "Low", right: "High" };
        ...
        {currentSelectedFacetData && (
          <Sheet open={isInsightPanelOpen} onOpenChange={setIsInsightPanelOpen}>
            <SheetContent
              className="w-full max-w-md sm:max-w-lg md:max-w-xl p-0 glassmorphic-card !bg-card/80 backdrop-blur-xl"
              side="right"
            >
              <ScrollArea className="h-full">
                <div className="p-6">
                  <SheetHeader className="mb-8">
                    <div className="flex justify-between items-start">
                      <div className="flex items-center gap-3">
                        <FacetIcon
                          facetName={currentSelectedFacetData.name}
                          className="h-10 w-10"
                        />
                        <div>
                          <SheetTitle
                            className={`text-3xl mb-0 ${getFacetClass(
                              "text",
                              currentSelectedFacetData.name.toLowerCase() as any,
                              "700"
                            )}`}
                          >
                          ...
                          <SheetDescription className="text-sm -mt-1">
                            {currentSelectedFacetData.tagline}
                          </SheetDescription>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="space-y-8">
                    <GlassCard>
                      ...
                      <p
                        className={`text-2xl font-bold ${getFacetClass(
                          "text",
                          currentSelectedFacetData.name.toLowerCase() as any,
                          "700"
                        )}`}
                      >
                        ...
                        currentUserScoreForSelectedFacet !== null
                          ? `${Math.round(
                              currentUserScoreForSelectedFacet * 100
                            )}%`
                          : "N/A"}
                      </p>
                      {currentUserScoreForSelectedFacet !== undefined &&
                        currentUserScoreForSelectedFacet !== null && (
                          <p className="text-xs text-muted-foreground">
                            {getQualitativeScoreDescription(
                              currentUserScoreForSelectedFacet,
                              currentSelectedFacetData.name
                            )}
                          </p>
                        )}
                    ...
                    {currentSelectedFacetData.deepDive
                    ...
                    {(currentSelectedFacetData.deepDive?.tensionsPlaceholder ||
                      currentSelectedFacetData.deepDive
                        ?.blindSpotsPlaceholder) && (
                      <GlassCard>
                        <h3 className="text-lg font-semibold mb-2">
                          Possible Tensions / Blind Spots
                        </h3>
                        {currentSelectedFacetData.deepDive
                          .tensionsPlaceholder && (
                          <p className="text-sm text-muted-foreground">
                    ...
                    {currentSelectedFacetData.deepDive?.reflectionPrompts &&
                      currentSelectedFacetData.deepDive.reflectionPrompts
                        .length > 0 && (
                        <GlassCard>
                          <h3 className="text-lg font-semibold mb-2">
                          ...
                          <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground">
                            {currentSelectedFacetData.deepDive.reflectionPrompts.map(
                              (prompt, idx) => (
        ...
        <section className="glassmorphic-card p-6 md:p-8 mt-16">
          <h2 className="text-2xl font-bold mb-8 text-center text-foreground roygbiv-gradient-underline pb-2">
            About the Meta-Prism Worldview Assessment Tool
          </h2>
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <strong
                      className={cn(
                        ...
                        getFacetClass("text", facetKey, "700")
                      )}
                    >
                      {item.title}
                    </strong>
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <div
            ...
            aria-label={`${facetName} spectrum: ${spectrumPoleLabels.left} to ${
          ...
          >
            ...
            >
              ...
              <svg
                ...
                height="10"
                viewBox="0 0 14 10"
                className="fill-slate-900/90 dark:fill-black/80 drop-shadow-md mx-auto mt-px"
        ...
        >
          ...
          <p className="text-xs text-muted-foreground/80">
            Facet:{" "}
            {FACET_INFO[facetKey as keyof typeof FACET_INFO]?.name || facetName}
          </p>
        </TooltipContent>
      </Tooltip>
