...
export const FACETS: Record<FacetName, Facet> = {
  Ontology: {
    ...
    deepDive: {
      ...
      archetypalPatterns: [
        { title: "The Rational Skeptic", scoreRange: "Aligns with Materialism (approx 0.20)", description: "Prioritizes scientific realism. Truth is derived from measurable evidence and logic.", icon: "atom" },
        { title: "The Integral Synthesizer", scoreRange: "Aligns with Relational / Dualist (approx 0.55)", description: "Holds multiple ontologies together—material and spiritual, inner and outer.", icon: "atom" },
        { title: "The Transcendent Mystic", scoreRange: "Aligns with Idealism / Non-Dualist (approx 0.95)", description: "Sees all phenomena as reflections of a single underlying consciousness or spirit.", icon: "atom" }
      ],
      reflectionPrompts: [
  ...
  Epistemology: {
    ...
    deepDive: {
      ...
      spectrumExplanation: "Epistemology ranges from strict empiricism (knowledge gained only through the senses) to intuitional or revelatory modes (where knowledge is direct, innate, or transmitted through sacred sources). Most worldviews blend empirical, rational, and mystical approaches to truth.",
      ...
      strengthsPlaceholder: "Empiricism fosters critical thinking and objectivity. An Integrative approach allows for holistic understanding and adaptability. A Revelatory/Intuitional stance can lead to profound personal insights and strong conviction.",
      tensionsPlaceholder: "Empirical approaches might struggle with purely subjective truths. Revelatory/Intuitional stances may conflict with empirical evidence. Integrative views must navigate how to weigh diverse sources.",
      blindSpotsPlaceholder: "Over-reliance on empiricism might dismiss non-scientific wisdom. A purely intuitive approach might neglect critical assessment. Integrative views may lack a consistent epistemological anchor."
    }
  },
  Praxeology: {
    name: "Praxeology",
    ...
    deepDive: {
      introduction: "Praxeology asks: How should we act? This domain shapes your approach to will, action, and agency. It guides your sense of purpose, choice, and responsibility in the world.",
      spectrumExplanation: "Praxeology spans from Hierarchical approaches (emphasizing rules, duty, and established order) to Egalitarian ones (emphasizing individual autonomy, context, and emergent consensus).",
      ...
      archetypalPatterns: [
        { title: "The Lawkeeper", scoreRange: "Low (approx 0.20)", description: "Upholds established structures, rules, and duties; values order and tradition.", icon: "zap" },
        { title: "The Pragmatist", scoreRange: "Mid (approx 0.55)", description: "Adapts actions to the situation, balancing principles with practical outcomes and individual needs.", icon: "zap" },
        { title: "The Liberator", scoreRange: "High (approx 0.85)", description: "Challenges hierarchies, champions individual freedom and self-governance; acts from internal locus of control.", icon: "zap" }
      ],
      reflectionPrompts: [
      ...
      strengthsPlaceholder: "A Hierarchical approach provides stability and clarity. A Contextual view allows for nuanced, adaptable solutions. An Egalitarian stance fosters innovation and individual empowerment.",
      tensionsPlaceholder: "Hierarchical systems may resist necessary change. Egalitarian approaches can struggle with large-scale coordination. Contextual ethics may lack consistent guiding principles.",
      blindSpotsPlaceholder: "Strong Hierarchical views might overlook individual needs. Strong Egalitarian views may discount the value of established wisdom. Contextual views can appear unpredictable if not grounded in deeper values."
    }
  },
  Axiology: {
    name: "Axiology",
    ...
    deepDive: {
      ...
      archetypalPatterns: [
        { title: "The Achiever", scoreRange: "Low (approx 0.25)", description: "Values success, personal gain, and tangible accomplishments; self-reliance is key.", icon: "heart" },
        { title: "The Ethicist", scoreRange: "Mid (approx 0.55)", description: "Values justice, fairness, human dignity, and ethical principles; seeks balance between individual rights and community needs.", icon: "heart" },
        { title: "The Altruist", scoreRange: "High (approx 0.90)", description: "Values collective well-being, service to others, and often transpersonal or sacred ideals over individual gain.", icon: "heart" }
      ],
      reflectionPrompts: [
      ...
      strengthsPlaceholder: "Individualism can foster innovation and personal responsibility. A Relational view promotes empathy and fair compromise. Collectivism drives social good and solidarity.",
      tensionsPlaceholder: "Individual freedoms can conflict with collective responsibilities. Defining 'the good' differs vastly between these poles. Relational views must balance personal needs with group demands.",
      blindSpotsPlaceholder: "Strong Individualism might overlook systemic inequalities. Strong Collectivism might undervalue individual dissent. Relational views may struggle when individual and collective needs are in sharp conflict."
    }
  },
  Mythology: {
    name: "Mythology",
    ...
    deepDive: {
      ...
      archetypalPatterns: [
        { title: "The Literalist", scoreRange: "Low (approx 0.10)", description: "Adheres to tradition; takes stories as concrete reality or historical fact.", icon: "bookOpen" },
        { title: "The Symbolist", scoreRange: "Mid (approx 0.60)", description: "Sees stories as maps of the soul or society; seeks meaning beneath the surface, finding universal patterns.", icon: "bookOpen" },
        { title: "The Mythic Weaver", scoreRange: "High (approx 0.85)", description: "Lives in symbolic imagination; finds truth in metaphor, recurring cosmic cycles, and participates in creating new myths.", icon: "bookOpen" }
      ],
      reflectionPrompts: [
      ...
      strengthsPlaceholder: "A Linear view provides direction and historical identity. A Psychological/Integrative view offers deep personal insight. A Cyclical/Eternal view fosters resilience and appreciation for enduring symbolic wisdom.",
      tensionsPlaceholder: "Literal historical accounts may conflict with symbolic interpretations. A sense of unique destiny (Linear) can clash with perceptions of timeless patterns (Cyclical/Eternal).",
      blindSpotsPlaceholder: "A strong Linear view might overlook symbolic depth. A Psychological view might reduce myths to internal states. A Cyclical view might underemphasize unique historical events."
    }
  },
  Cosmology: {
    name: "Cosmology",
    ...
    deepDive: {
      ...
      archetypalPatterns: [
        { title: "The Rational Materialist", scoreRange: "Low (approx 0.10)", description: "Sees the universe as impersonal, governed by discoverable physical laws or chance; values empirical evidence.", icon: "globe" },
        { title: "The Ecological Systems Thinker", scoreRange: "Mid (approx 0.60)", description: "Recognizes complex interdependence; sees cosmos as a living network or evolving organism, often valuing balance and sustainability.", icon: "globe" },
        { title: "The Cosmic Mystic", scoreRange: "High (approx 0.90)", description: "Experiences the universe as a conscious whole, rich with meaning, and potentially guided by a divine or spiritual principle.", icon: "globe" }
      ],
      reflectionPrompts: [
      ...
      strengthsPlaceholder: "A Mechanistic view excels in scientific analysis. An Organic view fosters ecological awareness. A Sacred/Spiritual view can inspire reverence and ethical responsibility.",
      tensionsPlaceholder: "Scientific models may conflict with experiences of a conscious cosmos. Randomness in nature can challenge concepts of divine order.",
      blindSpotsPlaceholder: "A Mechanistic view might dismiss subjective cosmic connection. A Sacred/Spiritual view might struggle with cosmic indifference or suffering not fitting a benevolent design."
    }
  },
  Teleology: {
    name: "Teleology",
    ...
    deepDive: {
      ...
      spectrumExplanation: "Teleology spans from a view where purpose is Existential or self-created in a universe without intrinsic goals (low scores), to one where purpose is Divinely ordained or inherent in the cosmos (high scores). Many find meaning in relational or emergent purposes that bridge these.",
      ...
      archetypalPatterns: [
        { title: "The Existential Wanderer", scoreRange: "Low (approx 0.05)", description: "Aligns with self-created meaning; moves through life without certainty of fixed purpose, creating meaning moment by moment.", icon: "target" },
        { title: "The Purposeful Achiever", scoreRange: "Mid (approx 0.55)", description: "Aligns with relational or emergent purpose; finds meaning through growth, challenge, conscious choice, and often in relation to others or a larger community.", icon: "target" },
        { title: "The Destiny Believer", scoreRange: "High (approx 0.95)", description: "Aligns with divine or cosmic purpose; feels guided by a larger plan or spiritual calling, seeing purpose in all events.", icon: "target" }
      ],
      reflectionPrompts: [
      ...
      strengthsPlaceholder: "An Existential view champions individual freedom and creativity. A Relational/Emergent view fosters community and adaptability. A Divine/Cosmic view can provide resilience and a sense of guidance.",
      tensionsPlaceholder: "The burden of total freedom (Existential) can conflict with the desire for inherent meaning (Divine). Individual purpose may clash with perceived collective destiny.",
      blindSpotsPlaceholder: "A strong Existential view might feel overwhelming without external guidance. A strong Divine/Cosmic view might struggle with ambiguity or events contradicting a benevolent plan."
    }
  },
};
